 ...
 */
public class MapTwofrg extends Fragment {
    ...
    public static MapTwofrg newInstance(int unitNo) {
        MapTwofrg fragment = new MapTwofrg();
    ...
    private void showPaoPao(Exhibition exhibition) {
        ...
        Glide.with(MapTwofrg.this).load(path)
