...
public class CreateDialog extends Dialog {
    ...
    private void init(Context context) {
        ...
        params = CreateDialog.this.getWindow().getAttributes();
     ...
     * @return
     */
    public CreateDialog title(CharSequence title) {
     ...
     * @return
     */
    public CreateDialog message(CharSequence msg) {
     ...
     * @return
     */
    public CreateDialog message(int msg) {
        swipFloor.setVisibility(View.VISIBLE);
        swipFloor.setText(msg);
        return this;
    }
...
//    }
     ...
     * @return
     */
    public CreateDialog pBtnText(CharSequence text) {
     ...
     * @return
     */
    public CreateDialog pBtnText(int text) {
        sureDialog.setVisibility(View.VISIBLE);
        sureDialog.setText(text);
        return this;
    }
     ...
     * @return
     */
    public CreateDialog pBtnClickListener(View.OnClickListener click) {
     ...
     * @return
     */
    public CreateDialog baseEffects(BaseEffects baseEffects) {
     ...
     * @return
     */
    public CreateDialog outsideCancelable(boolean outsideCancelable) {
     ...
     * @return
     */
    public CreateDialog setTypeface(Typeface typeface) {
